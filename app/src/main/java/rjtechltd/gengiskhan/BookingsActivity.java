...
public class BookingsActivity extends AppCompatActivity {
    ...
    public void onButtonClickedPending(View view){
        Intent intent = new Intent(this, PendingActivity.class);
        startActivity(intent);
    }

    public void onButtonClickedExtraordinary(View view){
        Intent intent = new Intent(this, ExtraordinaryActivity.class);
        startActivity(intent);
    }
